      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 glass rounded-full flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-brand-blue transition-colors">
                <Instagram size={20} />
              </a>
              <a href="#" className="w-10 h-10 glass rounded-full flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-brand-blue transition-colors">
                <Linkedin size={20} />
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-brand-blue transition-colors">Privacidade</a></li>
              <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-brand-blue transition-colors">Termos de Uso</a></li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            © {new Date().getFullYear()} Fluxo Sistemas. Todos os direitos reservados.
          </p>
          <p className="text-slate-500 dark:text-slate-400 text-sm flex items-center gap-1">
            Desenvolvido com <span className="text-red-500">❤</span> por Fluxo Sistemas
          </p>
        </div>
      </div>
    </footer>
